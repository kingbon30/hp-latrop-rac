...
@section('head')
<title>Add Listing - Car Portal PH</title>
  <!-- Fancy File -->
	              	...
	              	<div class="row">
				        ...
				        <div class="col-md-6">
			                ...
			                <div class="box-body">
					            ...
					            <div class="form-group col-sm-6">
					                <label>Milleage(km)</label>
					                <input class="form-control form-control-sm " placeholder="km" type="text" helo="numbers"  maxlength="6" minlength="3" name="milleage" value="{{ old('milleage')}}" required>
					            </div>

			                    {{-- listing id --}}
			                	<input  class="form-control form-control-sm" type="hidden" value="<?php
			                   	$seed = str_split('ABCDEFGHIJKLMNOPQRSTUVWXYZ'.'0123456789'); // and any other characters
			                    shuffle($seed); // probably optional since array_is randomized; this may be redundant
			                    $rand = '';
			                    foreach (array_rand($seed, 10) as $k) $rand .= $seed[$k];
			                    echo $rand;
			                    ?>"  required name="listing_id">
					            ...
					            <div class="form-group col-sm-6">
					                <label>Engine(L)</label>
			                      	<input class="form-control form-control-sm"  placeholder="1.5" type="text"   helo="numbers"  name="engine" value="{{ old('engine')}}" required>
					            </div>
					            ...
					            <div class="form-group col-sm-6">
					                <label>Edition</label>
			                      	<input  class="form-control"  placeholder="" type="text"  name="edition" value="{{ old('edition')}}" >
					            </div>
					            ...
					            <div class="form-group col-sm-6">
					                <label>Price</label>
			                      	<input type="text" class="form-control text-left" id="currency" name="vehicle_price" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'prefix': '₱ ', 'placeholder': '0'" value="{{ old('vehicle_price')}}" required>
					            </div>
